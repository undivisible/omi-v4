...
pub(crate) const MODEL_CAPABILITIES: &[(&str, &[Capability])] = &[
    ...
    ("google/gemini-2.5-flash-lite", &[Capability::Text, Capability::AudioIn, Capability::ImageIn]),
    ("google/gemini-3.5-flash-lite", &[Capability::Text, Capability::AudioIn]),
    ("x-ai/grok-stt-1.0", &[Capability::AudioIn]),
    ("openai/gpt-audio-mini", &[Capability::Text, Capability::AudioOut]),
