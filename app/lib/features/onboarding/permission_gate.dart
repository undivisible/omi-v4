...
class _CapabilityRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final copy = switch (capability) {
      ...
      CoreCapability.inputMonitoring =>
        'I would like Input Monitoring so double-Shift and the cursor shake '
            'work even when another app is in front.',
      ...
      child: ExcludeSemantics(
        child: Padding(
          ...
          child: Material(
            ...
            child: InkWell(
              key: capability == CoreCapability.inputMonitoring
                  ? const Key('input_monitoring_row')
                  : null,
              borderRadius: BorderRadius.circular(16),
              onTap: onRequest,
              child: Padding(
