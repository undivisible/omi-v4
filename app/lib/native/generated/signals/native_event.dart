...
class NativeEventMemoryApplied extends NativeEvent {
  ...
  static NativeEventMemoryApplied load(BinaryDeserializer deserializer) {
    deserializer.increaseContainerDepth();
    final instance = NativeEventMemoryApplied(
      value: MemoryApplied.deserialize(deserializer),
    );
    deserializer.decreaseContainerDepth();
    return instance;
  }
  ...
  String toString() {
    ...
    return fullString ?? 'NativeEventMemoryApplied';
  }
}
...
class NativeEventMeetingStateChanged extends NativeEvent {
  ...
  static NativeEventMeetingStateChanged load(BinaryDeserializer deserializer) {
    deserializer.increaseContainerDepth();
    final instance = NativeEventMeetingStateChanged(
      value: MeetingStateChanged.deserialize(deserializer),
    );
    deserializer.decreaseContainerDepth();
    return instance;
  }
  ...
  String toString() {
    ...
    return fullString ?? 'NativeEventMeetingStateChanged';
  }
}
...
class NativeEventMeetingInsight extends NativeEvent {
  ...
  static NativeEventMeetingInsight load(BinaryDeserializer deserializer) {
    deserializer.increaseContainerDepth();
    final instance = NativeEventMeetingInsight(
      value: MeetingInsight.deserialize(deserializer),
    );
    deserializer.decreaseContainerDepth();
    return instance;
  }
  ...
  String toString() {
    ...
    return fullString ?? 'NativeEventMeetingInsight';
  }
}
...
class NativeEventMeetingCompleted extends NativeEvent {
  ...
  static NativeEventMeetingCompleted load(BinaryDeserializer deserializer) {
    deserializer.increaseContainerDepth();
    final instance = NativeEventMeetingCompleted(
      value: MeetingCompleted.deserialize(deserializer),
    );
    deserializer.decreaseContainerDepth();
    return instance;
  }
