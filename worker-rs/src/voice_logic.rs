...
mod tests {
    ...
    fn iso_matches_known_instants() {
        ...
        assert_eq!(iso_from_epoch_ms(1_609_459_200_000), "2021-01-01T00:00:00.000Z");
        // With sub-second component.
        assert_eq!(iso_from_epoch_ms(1_609_459_200_123), "2021-01-01T00:00:00.123Z");
    }
    ...
    fn token_request_is_model_locked_and_two_use() {
        ...
        assert_eq!(body["newSessionExpireTime"], json!("1970-01-01T00:01:00.000Z"));
    }

    #[test]
    fn client_response_does_not_carry_the_key_and_echoes_model() {
        let body = client_response(0, "gemini-3.1-flash-live-preview", "auth_tokens/ephemeral-123");
